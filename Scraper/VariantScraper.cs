...
namespace RieltorApp.Scraper
{
    public class VariantScraper : BaseScraper
    {
        ...
        public override async Task<List<FoundApartment>> GetApartments(List<SearchArgumentModel> argumentModels, SearchType searchType)
        {
            ...
            var url = searchType == SearchType.Buy ? "https://variant-nk.ru/object/search/novokuznetsk/kvartiry/prodam?page=1" : "https://variant-nk.ru/object/search/novokuznetsk/kvartiry/arenda?page=1";
